...
(async () => {
  ...
  // const dirPath = path.resolve("./data"); // → maakt ./data map aan in je project
  // const filePath = path.join(dirPath, "storageState.json");

  // // Als map niet bestaat, maak hem aan
  // if (!fs.existsSync(dirPath)) {
  //   fs.mkdirSync(dirPath, { recursive: true });
  // }

  // // Nu kun je veilig schrijven
